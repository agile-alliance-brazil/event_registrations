...
namespace :edition_2015 do
  ...
  task :seeds => :environment do
    ...
    # Period
    RegistrationPeriod.create!(start_at: Date.new(2015, 10, 8), end_at: Date.new(2015, 10, 15), event: event, price: 740)
    RegistrationPeriod.create!(start_at: Date.new(2015, 10, 15), end_at: Date.new(2015, 10, 21), event: event, price: 840)

    # Quotes
    RegistrationQuota.create!(event: event, quota: 100, price: 420)
    RegistrationQuota.create!(event: event, quota: 150, price: 540)
