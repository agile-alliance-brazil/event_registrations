...
if ARGV.size < 2
  ...
  puts ''
  puts "<origin_host>\t\tIP address or host uri without protocol. Eg inscricoes-staging.agilebrazil or 159.203.145.65"
  puts "<destination_host>\tIP address or host uri without protocol. Eg inscricoes-staging.agilebrazil or 159.203.145.65"
