class passenger-apache {
  ...
  exec { "passenger-install-apache2-module":
    ...
    path => "/usr/local/bin/",
    onlyif => "[ -f '/var/lib/gems/1.9.1/gems/passenger-4.0.37/buildout/apache2/mod_passenger.so' ]",
    creates => '/var/lib/gems/1.9.1/gems/passenger-4.0.37/buildout/apache2/mod_passenger.so',
    require => [
