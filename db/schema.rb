...
ActiveRecord::Schema.define(version: 20170425042251) do
  ...
  create_table "invoices", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.index ["invoiceable_type", "invoiceable_id"], name: "index_invoices_on_invoiceable_type_and_invoiceable_id", using: :btree
  end

  create_table "payment_notifications", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.index ["invoice_id"], name: "fk_rails_92030b1506", using: :btree
  end

  create_table "registration_groups", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "event_id"
    t.string   "name"
    t.integer  "capacity"
    t.integer  "discount"
    ...
    t.index ["invoice_id"], name: "fk_rails_9544e3707e", using: :btree
  end

  create_table "registration_periods", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "event_id"
    t.string   "title"
    t.datetime "start_at"
    t.datetime "end_at"
  ...
  create_table "registration_quotas", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    t.integer  "quota"
    t.datetime "created_at"
    t.datetime "updated_at"
    t.integer  "event_id"
  ...
  create_table "users", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci" do |t|
    ...
    t.datetime "updated_at"
    t.integer  "registration_group_id"
    t.index ["registration_group_id"], name: "fk_rails_ebe9fba698", using: :btree
  end
