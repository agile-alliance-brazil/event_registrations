...
namespace :technical_debt_2015 do
  ...
  task :seeds => :environment do
    ...
    if event.present?
      ...
      event = Event.create!(name: "Technical Debt - A Manager's Guide", price_table_link: 'http://localhost:9292/link', full_price: 840.00, start_date: Date.new(2015, 10, 19), end_date: Date.new(2015, 10, 19))
