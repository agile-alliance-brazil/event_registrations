...
1. Add the new ruby version to the infrastructure code
2. Add the new ruby version to the host machines
3. Switch local development to use the new version and ensure everything works
4. Change the host machines default ruby version for usage
5. Remove the old ruby version from host machines
6. Remove the old ruby version from the infrastructure code
